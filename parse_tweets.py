...
for f in onlyfiles:
	...
	for line in open(f_name,'r'):
		...
		'''
		f1.write(processed + "\t" + fields[7] + "\t" +  created_date+  "\t" + original_tweet + "\t" + str(is_retweet) + "\n")
		f1.flush()
		f2.write(fields[21] + "\t" + fields[20] + "\t" + fields[22] + "\t" + str(1) + "\t" + processed +"\n")
		f2.flush()
